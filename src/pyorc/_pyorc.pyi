...
class reader:
    ...
    def _statistics(self, arg0: int) -> tuple: ...
...
class writer:
    ...
    def _add_user_metadata(self, arg0: str, arg1: bytes) -> None: ...
    def close(self) -> None: ...
    def write(self, arg0: object) -> None: ...
    def writerows(self, arg0: typing.Iterable) -> int: ...
    @property
    def current_row(self) -> int:
        """
        :type: int
